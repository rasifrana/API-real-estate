    ...
    return (
        <section className="px-6 py-32 border-b-2">
            <div className="flex flex-col md:w-1/2 mx-auto justify-center items-center">
                ...
                <motion.h2 initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 5 }} className=" text-3xl text-center md:w-3/4 my-6">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-3 mt-24" style={{ minHeight: '400px' }}>
                <motion.div initial={{ opacity: 0, y: 50 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 5 }} className="flex flex-col justify-center items-start text-3xl">
                    <p>
